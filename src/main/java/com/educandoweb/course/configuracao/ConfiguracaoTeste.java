...
import com.educandoweb.course.entidades.Pagamento;
...
import com.educandoweb.course.repositorios.RepositorioItemPedido;
...
public class ConfiguracaoTeste implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Pagamento pa1 = new Pagamento(null, Instant.parse("2019-06-20T21:53:07Z"), p1);
		p1.setPagamento(pa1);
